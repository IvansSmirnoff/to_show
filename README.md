...
|[Gender_neural](https://github.com/IvansSmirnoff/to_show/tree/main/Gender_neural)   |pytorch, pandas, numpy, tar   |Neural Network based gender prediction classifier with a usage script   |Ru   |
